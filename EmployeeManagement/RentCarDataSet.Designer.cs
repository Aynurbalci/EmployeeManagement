...
namespace EmployeeManagement {
    ...
    public partial class RentCarDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string PhoneNumber, string Email, string Address, string Gender, byte[] Picture) {
            ...
            public string Name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Employees\' tablosundaki \'Name\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public string PhoneNumber {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Employees\' tablosundaki \'PhoneNumber\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public string Address {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Employees\' tablosundaki \'Address\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public string Gender {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Employees\' tablosundaki \'Gender\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace EmployeeManagement.RentCarDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`Employee_ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Gender` IS NULL) OR (`Gender` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`Name`, `PhoneNumber`, `Email`, `Address`, `Gender`, `Pi" +
                "cture`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `Name` = ?, `PhoneNumber` = ?, `Email` = ?, `Address` = ?, `Gender` = ?, `Picture` = ? WHERE ((`Employee_ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Gender` IS NULL) OR (`Gender` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EmployeeManagement.Properties.Settings.Default.RentCarConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Employee_ID, Name, PhoneNumber, Email, Address, Gender, Picture FROM Emplo" +
                "yees";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Param1", global::System.Data.OleDb.OleDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        public virtual int Fill(RentCarDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual RentCarDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RentCarDataSet.EmployeesDataTable dataTable = new RentCarDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RentCarDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Employee_ID, string Original_Name, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_Gender) {
        ...
        public virtual int Insert(string Name, string PhoneNumber, string Email, string Address, string Gender, byte[] Picture) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string PhoneNumber, string Email, string Address, string Gender, byte[] Picture, int Original_Employee_ID, string Original_Name, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_Gender) {
            if ((Name == null)) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> CountGender(string Gender) {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE `Login` SET `Username` = ?, `Password` = ? WHERE (((? = 1 AND `Username` I" +
                "S NULL) OR (`Username` = ?)) AND (`Password` = ?))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(RentCarDataSet.LoginDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual RentCarDataSet.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RentCarDataSet.LoginDataTable dataTable = new RentCarDataSet.LoginDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        public virtual int FillBy(RentCarDataSet.LoginDataTable dataTable, string Username, string Password) {
        ...
        public virtual RentCarDataSet.LoginDataTable NamePassword(string Username, string Password) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Username == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RentCarDataSet.LoginDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
